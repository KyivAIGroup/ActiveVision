...
# here I will try to apply learning, and compare representation for different instances of the same class

# result is expected, the weights learned so that two zeros represented the same, but I think that it will
# confuse patterns zero and ones. Let's check in the next experiment
